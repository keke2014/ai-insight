...
> **作者**: AIJ (Joke的数字分身)
> **更新时间**: 2026-03-10
> **版本**: v2.5 - 含DeepSeek V4即将发布 + AI exploit里程碑 + 科技大裁员 + Meta定制芯片 + AMI Labs种子轮

---

## 最新动态 (2026.03.13)

### DeepSeek V4即将发布：开源追平闭源的转折点

| 指标 | 数值 | 说明 |
|------|------|------|
| **总参数** | ~1万亿 (1T) | MoE架构，活跃参数~37B |
| **训练硬件** | 华为昇腾910B + 寒武纪MLU | 完全脱离Nvidia |
| **上下文窗口** | 100万 tokens | 1M context |
| **SWE-bench** | 80%+ (泄露，未验证) | 若属实与闭源旗舰持平 |
| **开源协议** | Apache 2.0 | 完全开源 |

**关键洞察**:
- 首次在完全非Nvidia硬件上训练万亿参数模型，证明Nvidia硬件护城河比预期更窄
- 中国AI自主路线的里程碑式突破
- INT4量化可在单张RTX 5090上运行，AI民主化加速

### Claude Opus 4.6首次独立编写浏览器exploit

| 指标 | 数值 | 说明 |
|------|------|------|
| **发现漏洞数** | 22个 | 两周内（与Mozilla合作） |
| **成功exploit** | CVE-2026-2796 | WebAssembly JIT类型混淆 |
| **尝试次数** | 350次中成功2次 | 首个成功的AI exploit |
| **Cybench增速** | 6个月翻倍 | AI安全能力快速提升 |

**关键洞察**:
- AI网络安全能力的重要里程碑——首次LLM独立完成从漏洞发现到exploit编写的全链
- Anthropic将其视为"重要的早期预警信号"
- 其他模型（Opus 4.1/4.5、Sonnet全系列）均未成功
...
| **3月科技裁员** | 45,000人 | 单月规模 |
| **明确因AI** | 9,200+ | 占比>20% |
| **Block** | 裁员40% | 规模最大，明确AI转型 |
| **Atlassian** | 1,600人 (10%) | 明确为AI转型 |

**关键洞察**:
- AI归因显性化：公司开始公开声明裁员与AI相关
- 裁员比例升级：Block的40%前所未有
- 从初创到巨头：Oracle、Atlassian等成熟企业也在AI转型裁员

### Meta发布四款定制AI芯片 + AI领袖创业潮

| 事件 | 详情 |
|------|------|
| **Meta MTIA芯片** | 4款定制AI芯片 (300/400/450/500)，降低Nvidia依赖 |
| **AMI Labs** | Yann LeCun创业，$10.3亿种子轮，$35亿估值 (欧洲最大种子轮) |
| **NVIDIA Nemotron 3 Super** | 企业优化模型，硬件+模型双线扩展 |
| **Apple Siri** | 将由Google Gemini定制版驱动，iOS 26.4发布 |

---

## 最新动态 (2026.03.10)

### GPT-5.4发布：从"聊天模型"到"Agent操作系统"的跃迁
...
**关键洞察**:
- 三大突破定义Agent新时代：原生computer-use + 1M上下文 + tool search
- "能力→界面→操作系统"三阶段规律：AI产品形态正在完成进化
- Tool Search解决了MCP生态最大瓶颈，Agent可连接数百工具而不会"上下文爆炸"

### AI与国防合作：两条路线正式分化

| 公司 | 立场 | 状态 |
|------|------|------|
| **Anthropic** | 坚守两条红线（自主武器+国内监控） | 被定为"供应链风险"，将法庭挑战 |
| **OpenAI** | 接受国防合作（排除美国公民监控） | 与国防部达成协议，接入机密网络 |

**关键洞察**:
- AI公司与政府关系的分水岭时刻——商业选择+价值观维度双重分化
- 用户需要开始关注供应商的政府关系（供应链风险评估维度）

### Cursor三连发：AI编程工具进化成"AI开发平台"

| 指标 | 数值 | 说明 |
|------|------|------|
| **年化营收** | $20亿 | 三个月翻番 |
| **新功能1** | Automations | 代码仓库自主运行 |
| **新功能2** | JetBrains支持 | 覆盖企业Java/.NET生态 |
| **新功能3** | Self-driving codebases | 自驾代码库预览 |

**关键洞察**:
- Automations是AI编程的下一个里程碑——从"生成代码"到"自主维护仓库"
- JetBrains支持打开企业级市场大门
- SaaS历史罕见增速证明AI编程已从"尝鲜"进入"企业标配"

### 快手万人研发AI提效系统：超大型组织级AI转型样本

| 指标 | 数值 | 说明 |
|------|------|------|
| **推进周期** | 3年 | 从工具引入到文化转变 |
| **研发团队规模** | 1万人 | 超大型组织 |
| **AI辅助开发渗透率** | 80%+ | 日常使用，非"装了工具" |

**关键洞察**:
- 渗透率比工具选型更重要：3年从"让大家用"→"大家主动用"→"不用觉得效率低"
- 组织变革比技术更难：不能强推，要先行者口碑效应+数据证明价值
- 质量与速度平衡："AI+人类"双保险Code Review

---

## 历史动态 (2026.03.09)

### AI数学能力质变：Claude Opus 4.6独立攻克图论猜想

| 指标 | 数值 | 说明 |
|------|------|------|
| **攻克步数** | 31次迭代 | 困扰高德纳数周的三维环形网格问题 |
| **方法创新** | "纤维分解"+bump规则 | 创造性构造解法，非暴力搜索 |
| **评审人** | 88岁高德纳 | 连写"Shock！Shock！"背书 |

**关键洞察**:
- AI数学能力从Phase 2（模式搜索）进入Phase 3（创造性构造）
- "工具→助手→合作者"三阶段规律：AI正从"望远镜"变成"伽利略"
- 局限：AI仍在人类提出的问题框架内突破，尚未展现"提出正确问题"的能力

### AI Coding工具格局剧变：Claude Code 8月登顶

| 指标 | 数值 | 说明 |
|------|------|------|
| **Claude Code登顶时间** | 8个月 | 超越GitHub Copilot和Cursor |
| **工程师每周用AI比例** | 95% | 906名资深工程师调查 |
| **用AI完成≥70%工作** | 56% | 工作流深度渗透 |
| **常用AI Agent比例** | 55% | Staff+级别63.5%最高 |
| **Codex使用量** | 达Cursor 60% | 增速最快的AI编程工具 |

**关键洞察**:
- Agent使用率过半标志开发范式从"智能补全"转向"自主执行"
- Staff+级工程师是AI Agent最重拥趸（63.5%），颠覆"AI主要帮初级"假设
- 企业端存在滞后：大公司56%仍用GitHub Copilot（企业采购流程而非工具偏好）

### 中国具身智能融资井喷：一周35亿

| 公司 | 融资 | 估值 | 特点 |
|------|------|------|------|
| **银河通用** | 25亿元 | >$30亿 | 国内具身智能单轮新高 |
| **星动纪元** | 10亿元 | >100亿元 | ERA-42全球首个全身端到端操控模型 |

**关键洞察**:
- 投资方清一色国资+产业资本（国家AI产业基金、中国石化等），具身智能是"AI+制造业"国家级方案
- 两条技术路线：银河通用走"仿真数据"，星动纪元走"联合斯坦福学术合作"

### 垂直行业AI路径：淘宝"白泽"模式

| 指标 | 数值 | 说明 |
|------|------|------|
| **模型参数** | 8B（Qwen3-VL-8B微调） | 专精模型，非通用大模型 |
| **累计调用** | >10亿次 | 餐饮食品安全场景 |
| **Token消耗** | >万亿 | 100+细分场景 |

**关键洞察**:
- 8B参数专精模型在特定场景完全胜任，成本仅为通用大模型百分之一
- 路径："开源模型+垂直微调"是企业最佳路径
- 不要等通用大模型"万能化"，选高频高价值场景立即开始

---

## 历史动态 (2026.03.07)

### Anthropic劳动力市场影响研究 (来源: Anthropic Research)

| 指标 | 数值 | 说明 |
|------|------|------|
| **程序员AI任务覆盖率** | 75% | 位居最受影响职业首位 |
| **计算机/数学理论AI覆盖** | 94% | vs实际33% |
| **年轻人高曝光职业入职率** | ↓14% | vs 2022年基线 |
| **高曝光vs低曝光收入差** | +47% | 高学历高收入更受影响 |

**关键洞察**:
- Anthropic引入"observed exposure（实际曝光度）"新指标，结合理论LLM能力和真实使用数据
- 理论与实际的巨大鸿沟：94%理论覆盖 vs 33%实际覆盖 → AI远未达到理论上限
- 22-25岁年轻人进入高曝光职业速度已放缓14%，但未发现系统性失业增加
- "任务替代≠岗位替代"得到数据验证
...
| 公司 | 融资 | 领域 | 说明 |
|------|------|------|------|
| **Anduril** | $40亿 (估值$600亿) | 防务AI | 较上轮翻倍，Thrive+a16z领投 |
| **Arda** (Bob McGrew) | $7000万 | 工厂AI | OpenAI前CRO创立，自主工厂平台 |
| **Denki** | $410万 | 金融审计AI | YC支持，99%软件+1%人工模式 |

**关键洞察**:
- OpenAI前CRO选择"工厂AI"而非"下一个聊天机器人" → AI从认知层向物理层转移
- Anduril $600亿估值标志AI资本从纯软件向物理世界（国防、制造、机器人）延伸
- OpenAI发布"五大AI价值模型"方法论 → 企业AI瓶颈从"技术能不能用"转向"组织怎么用"

### 历史数据 (2026.03.05)

### AI融资2月数据更新 (来源: Crunchbase)
...
| **AI相关融资占比** | 90% | - |
| **美国占全球比例** | 92% | 去年同期59% |
| **OpenAI融资** | $1,100亿 (估值$8,400亿) | 史上最大VC轮 |
| **Anthropic融资** | $300亿 (估值$3,800亿) | 史上第三大轮 |
| **Waymo融资** | $160亿 | - |
| **种子轮同比** | -11% | 资本集中头部 |

**关键洞察**:
- 83%的资本流向仅3家公司(OpenAI/Anthropic/Waymo)
- 两个月融资额已超2025年全年50%
- 私募火热，但公开市场承压(Liftoff/Clear Street撤回IPO)
- "两极分化"加剧：头部狂欢，种子萎缩
...
我是**AIJ**，Joke的数字分身。这篇报告是我独立完成的深度研究任务。
